...
const TRANSLATIONS = {
  tr: {
    ...
    navYtAccelerator: "Zen Cinema Pro",
    ...
    p1Desc: "YouTube'u kendi oynatma motoru ve CSS katmanı içinde çalıştırır; ışıkları kapatır, sayfayı karartır ve reklamları DOM seviyesinde anında geçersiz kılar.",
    ...
    p1F5: "Reklam sonrası oynatmayı otomatik devam ettirir",
    p1F6: "Ömür Boyu Ücretsiz Güncellemeler",
    p1F7: "🍿 YENİ: Zen Cinema Modu — ışıkları kapat, sayfayı karart, sürükleyici tiyatro deneyimi",
    p1Price: "₺499 / $19.99",
  ...
  en: {
    ...
    // GEN:PRODUCTS:START
    p1Title: "Zen Cinema Pro — Ad-Free Theater Mode",
    p1Tagline: "Watch Ad-Immune With Its Own Playback Engine",
    p1Desc: "Runs YouTube inside its own playback engine and CSS layer; dims the page, kills the lights, and neutralizes ads at the DOM level instantly.",
    ...
    p1F7: "🍿 NEW: Zen Cinema Mode — lights off, dimmed page, immersive theater experience",
    p1Price: "$19.99 / ₺499",
  ...
  es: {
    ...
    // GEN:PRODUCTS:START
    p1Title: "Zen Cinema Pro — Modo Cine Sin Anuncios",
    p1Tagline: "Inmune a los Anuncios Con su Propio Motor de Reproducción",
    p1Desc: "Ejecuta YouTube dentro de su propio motor de reproducción y capa CSS; atenúa la página, apaga las luces y neutraliza los anuncios a nivel DOM al instante.",
    ...
    p1F7: "🍿 NUEVO: Modo Zen Cinema — luces apagadas, página oscurecida, experiencia de cine inmersiva",
    p1Price: "$19.99 / ₺499",
  ...
  de: {
    ...
    // GEN:PRODUCTS:START
    p1Title: "Zen Cinema Pro — Werbefreier Kinomodus",
    p1Tagline: "Werbeimmun dank eigener Wiedergabe-Engine",
    p1Desc: "Führt YouTube in einer eigenen Wiedergabe-Engine und CSS-Ebene aus; dimmt die Seite, schaltet das Licht aus und neutralisiert Werbung sofort auf DOM-Ebene.",
    ...
    p1F7: "🍿 NEU: Zen Cinema Modus — Licht aus, abgedunkelte Seite, immersives Kino-Erlebnis",
    p1Price: "19,99 $ / 499 ₺",
